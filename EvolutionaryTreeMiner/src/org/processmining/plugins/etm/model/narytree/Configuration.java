...
public final class Configuration {
	...
	public static final byte XOR = NAryTree.XOR;//3;
	public static final byte AND = NAryTree.AND;//4;
	public static final byte SEQ = NAryTree.SEQ;//5;
	public static final byte ILV = NAryTree.ILV;//5;
	public static final byte REVSEQ = NAryTree.REVSEQ;//6;
	 ...
	 * returned byte does NOT correspond to {@link NAryTree} operator types but
