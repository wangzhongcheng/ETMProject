...
public class NAryTreeReplayerWithBasisILP extends
		AbstractNAryTreeReplayer<NAryTreeHead, NAryTreeBasisILPTail, NAryTreeBasisILPDelegate> {

	private NAryTreePostProcessor<NAryTreeHead, NAryTreeBasisILPTail> postProcessor;

	public NAryTreeReplayerWithBasisILP(AStarAlgorithm aStarLogAbstraction, Canceller canceller, NAryTree tree,
		...
		this.postProcessor = new NAryTreePostProcessor<NAryTreeHead, NAryTreeBasisILPTail>(delegate, tree,
	...
	protected NAryTreeBasisILPDelegate constructDelegate(AStarAlgorithm algorithm, NAryTree tree,
			int configurationNumber, int[] node2cost, int threads, boolean useOrRows) {
		return new NAryTreeBasisILPDelegate(algorithm, tree, configurationNumber, node2cost, threads, useOrRows);
	}
