...
public class NAryTreeReplayerWithHybridILP extends
		AbstractNAryTreeReplayer<NAryTreeHead, NAryTreeHybridILPTail, NAryTreeHybridILPDelegate> {

	private NAryTreePostProcessor<NAryTreeHead, NAryTreeHybridILPTail> postProcessor;

	public NAryTreeReplayerWithHybridILP(AStarAlgorithm aStarLogAbstraction, Canceller canceller, NAryTree tree,
	...
	protected NAryTreeHybridILPDelegate constructDelegate(AStarAlgorithm algorithm, NAryTree tree,
			int configurationNumber, int[] node2cost, int threads, boolean useOrRows) {
		return new NAryTreeHybridILPDelegate(algorithm, tree, configurationNumber, node2cost, threads, useOrRows);
	}
