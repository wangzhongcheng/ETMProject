...
public class NAryTreeReplayerWithNativeILP extends
		AbstractNAryTreeReplayer<NAryTreeHead, NAryTreeNativeILPTail, NAryTreeNativeILPDelegate> {

	private NAryTreePostProcessor<NAryTreeHead, NAryTreeNativeILPTail> postProcessor;
	private final boolean useBasisHistory;

	public NAryTreeReplayerWithNativeILP(AStarAlgorithm aStarLogAbstraction, Canceller canceller, NAryTree tree,
			...
			int[] moveCount, Map<Trace, TreeRecord> alignments, boolean useOrRows, boolean useBasisHistory,
		...
		this.postProcessor = new NAryTreePostProcessor<NAryTreeHead, NAryTreeNativeILPTail>(delegate, tree,
	...
	protected NAryTreeNativeILPDelegate constructDelegate(AStarAlgorithm algorithm, NAryTree tree,
			int configurationNumber, int[] node2cost, int threads, boolean useOrRows) {
		return new NAryTreeNativeILPDelegate(algorithm, tree, configurationNumber, node2cost, threads, useOrRows,
				useBasisHistory);
	}
