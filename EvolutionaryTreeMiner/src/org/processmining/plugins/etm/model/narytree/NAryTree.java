...
public interface NAryTree extends Comparable<NAryTree> {
	 ...
	 */
	public NAryTree swap(int node1, int node2);
	 ...
	 * @return NAryTree clone with this operation applied
	 */
	public NAryTree add(NAryTree source, int node, int par, int location);
	 ...
	 * @return NAryTree clone with this operation applied
	 */
	public NAryTree addChild(int operatorNode, int index, short leafType, byte configurationType);
	 ...
	 * @return NAryTree clone with this operation applied
	 */
	public NAryTree replace(int node, NAryTree source, int srcNode);
	 ...
	 * @return NAryTree clone with this operation applied
	 */
	public NAryTree move(int par, int location, int newParent, int newLocation);
