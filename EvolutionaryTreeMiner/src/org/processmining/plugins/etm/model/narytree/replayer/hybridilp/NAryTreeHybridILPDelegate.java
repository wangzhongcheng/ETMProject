...
public class NAryTreeHybridILPDelegate extends AbstractNAryTreeLPDelegate<NAryTreeHybridILPTail> implements
	...
	public NAryTreeHybridILPDelegate(AStarAlgorithm algorithm, NAryTree tree, int configurationNumber, int[] node2cost,
			int threads) {
	...
	protected NAryTreeHybridILPDelegate(AStarAlgorithm algorithm, NAryTree tree, int configurationNumber,
