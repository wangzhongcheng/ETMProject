...
public class InductiveMinerWrapper extends TreeFactoryAbstract {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < nrTries; i++) {
			NAryTree tree = IMW.generateRandomCandidate(reg.getRandom());
	 ...
	 * @return
	 */
	public static NAryTree callInductiveTreeMiner(CentralRegistry registry, IMLog filteredLog) {
		...
		NAryTree tree = convertor.convert(pt);
