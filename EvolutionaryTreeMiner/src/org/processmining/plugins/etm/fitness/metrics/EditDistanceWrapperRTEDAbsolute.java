...
public class EditDistanceWrapperRTEDAbsolute extends TreeFitnessAbstract {
	 ...
	 * @param base
	 */
	public EditDistanceWrapperRTEDAbsolute(Collection<NAryTree> base) {
		for (NAryTree tree : base) {
	...
	public LblTree toLblTree(NAryTree tree) {
		return toLblTree(tree, 0);
	}

	public LblTree toLblTree(NAryTree tree, int n) {
