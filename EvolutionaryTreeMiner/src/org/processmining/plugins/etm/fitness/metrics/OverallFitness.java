...
public class OverallFitness extends TreeFitnessAbstract {
	...
	public synchronized double getFitness(NAryTree candidate, List<? extends NAryTree> population) {
	...
	public static class OverallFitnessGUI extends TreeFitnessGUISettingsAbstract<OverallFitness> {
		...
		public OverallFitnessGUI(final ETMParamAbstract param, PluginContext context) {
			super(param);
			...
			TreeFitnessAbstract eval = param.getFitnessEvaluator();
			if (eval != null) {
