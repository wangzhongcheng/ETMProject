...
import org.processmining.plugins.etm.model.narytree.replayer.NAryTreeReplayer.PerformanceType;
...
import org.processmining.plugins.etm.model.narytree.replayer.basisilp2.NAryTreeReplayerWithBasis2ILP;
...
//				System.out.println(recordCost + " vs " + totalCost);
	...
	public NAryTreeReplayer<?, ?, ?> setupReplayer(NAryTree candidate, AStarAlgorithm algorithm,
