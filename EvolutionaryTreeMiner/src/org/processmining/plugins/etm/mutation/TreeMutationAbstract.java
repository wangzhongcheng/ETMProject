...
public abstract class TreeMutationAbstract {
	//TODO make more like fitness (e.g. annotation, info object (focus on dim, smart/dumb, ...)
	...
	protected NAryTreeHistory.TypesOfChange typeOfChange = NAryTreeHistory.TypesOfChange.OTHER;
	 ...
	 * tree, not beeing the whole tree). Otherwise use the mutate(Tree) variant.
	 * 
	 * @param node
	 *            Node to mutate on
	...
	protected void noChange() {
		...
		typeOfChange = NAryTreeHistory.TypesOfChange.OTHER;
	}
