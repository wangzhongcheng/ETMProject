...
public class CombinationCrossover<R extends NAryTree> extends AbstractCrossover<NAryTree> {
	...
	protected List<NAryTree> mate(NAryTree parent1, NAryTree parent2, int numberOfCrossoverPoints, Random rng) {
		if (registry == null || !registry.getFitness(parent1).behaviorCounter.isAlignmentSet() 
			...
			NAryTree tree1 = TreeUtils.fromString("LEAF: tau");
	...
	private List<NAryTree> dumbMate(NAryTree parent1, NAryTree parent2, int numberOfCrossoverPoints, Random rng) {
