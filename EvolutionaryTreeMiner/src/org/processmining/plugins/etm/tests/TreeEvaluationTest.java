...
public class TreeEvaluationTest {
	...
	public static void evaluateThesisQualityExamples() {
		...
		NAryTree treeFr = TreeUtils.fromString(treeStringFr, registry.getEventClasses());
		NAryTree treePe = TreeUtils.fromString(treeStringPe, registry.getEventClasses());
		NAryTree treeGe = TreeUtils.fromString(treeStringGe, registry.getEventClasses());

		NAryTree[] trees = new NAryTree[] { treeFr, treePe, treeGe };
		//NAryTree tree = TreeUtils.fromString(treeString, registry.getEventClasses());
