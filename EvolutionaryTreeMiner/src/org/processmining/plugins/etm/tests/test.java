...
//				.loadFromFile("C:\\Users\\jbuijs\\Documents\\TUe\\Random stuff\\000Event Logs\\BPI12_financial_log.xes.gz"); //BPI12 log
		XLog log = LogUtils
				.loadFromFile("D:\\a.xes.gz"); //BPI12 log
		...
		TreeRecord alignment = f.behaviorCounter.getAlignment(cr.getaStarAlgorithm().traceIterator().next());
	...
	public static void ETMp() throws IOException {
		...
		XLog eventlog = LogUtils.loadFromFile("D:\\a.xes.gz"); //BPI12 log
