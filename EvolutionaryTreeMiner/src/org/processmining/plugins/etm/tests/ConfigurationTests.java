...
public class ConfigurationTests {
	...
	private static void testTreeFunctions() {
		...
		NAryTreeImpl tree = (NAryTreeImpl) TreeUtils
		...
		tree = (NAryTreeImpl) mut.mutate(tree);
	...
	public static void testConfigurationApplication() {
		...
		NAryTree tree = TreeUtils.fromString(treeString, info.getEventClasses());
		
		System.out.println("tree: "+TreeUtils.toString(tree,info.getEventClasses()));
		
		NAryTree treeConf = tree.applyConfiguration(0);
