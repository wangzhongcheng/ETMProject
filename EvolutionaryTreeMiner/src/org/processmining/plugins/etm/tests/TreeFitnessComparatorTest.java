...
public class TreeFitnessComparatorTest {
	...
	public static void main(String[] args) {
		...
		NAryTree tree1 = TreeUtils.fromString("SEQ( LEAF: A )", info.getEventClasses());
		NAryTree tree2 = TreeUtils.fromString("SEQ( LEAF: B )", info.getEventClasses());
		NAryTree tree3 = TreeUtils.fromString("SEQ( LEAF: C )", info.getEventClasses());
		...
		List<NAryTree> sorted = reg.getSortedOn(false, new TreeFitnessInfo[] { f1, f2 });
