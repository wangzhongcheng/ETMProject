...
public abstract class AbstractTokenCountTailCompressor<T extends Tail> extends AbstractCompressor<T> {

	protected final short activities;
	protected int nodeMaskSize;
	protected final int activityBytes;

	public AbstractTokenCountTailCompressor(short nodes, short activities, short leafs) {
