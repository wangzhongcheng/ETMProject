...
/**
 * <p>General purpose engine for implementing Evolution Strategies.  Both (?+?) and (?,?)
 ...
 * evolution strategies.  Elitism is implicit in a (?+?) ES and undesirable for a (?,?) ES.</p>
...
public class EvolutionStrategyEngine<T extends Comparable<? super T>> extends AbstractEvolutionEngine<T>
{
     ...
     * @param eliteCount Ignored by evolution strategies.  Elitism is implicit in a (?+?)
     * ES and undesirable for a (?,?) ES.
