...
import org.uncommonseditedbyjoosbuijs.watchmaker.framework.interactive.InteractiveSelection;
...
public class GenerationalEvolutionEngine<T extends Comparable<? super T>> extends AbstractEvolutionEngine<T> {
	 ...
	 */
	public GenerationalEvolutionEngine(CandidateFactory<T> candidateFactory, EvolutionaryOperator<T> evolutionScheme,
	 ...
	 * It is not necessary to specify a fitness evaluator for interactive
	 * evolution.
	 * 
	 * @param candidateFactory
	 *            Factory used to create the initial population that is
